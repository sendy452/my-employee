    ...
    <table>
        <tbody>               
          ...
          <tr>
            ...
            <th><?php echo e($total_bobot); ?>%</th>
            <th colspan="2">Saran Jabatan : <?php echo e($jabatan->nama_divisi.'-'.$jabatan->bidang ?? '-'); ?></th>
            <?php $__currentLoopData = $totalkeahlian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\Apk\laragon\www\my-employee\resources\views/export-keahlian-karyawan.blade.php ENDPATH**/ ?>