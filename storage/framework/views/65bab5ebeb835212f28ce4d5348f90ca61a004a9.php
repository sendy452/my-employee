        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="<?php echo e(url('penilaian-kinerja')); ?>">
                <?php echo csrf_field(); ?>
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    <tbody>               
                    <form method="post" action="<?php echo e(route('add.penilaian.kinerja')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Apk\laragon\www\my-employee\resources\views/penilaian-kinerja.blade.php ENDPATH**/ ?>