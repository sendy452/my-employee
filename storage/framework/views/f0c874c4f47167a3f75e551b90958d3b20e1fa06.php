              ...
              <div class="card-body">
                ...
                <form method="post" action="<?php echo e(route('add.kinerja')); ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="target" placeholder="1 - 4">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Apk\laragon\www\scoring\resources\views/list-kinerja.blade.php ENDPATH**/ ?>