...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e($page =="laporan-penilaian-kinerja-divisi" || $page=="laporan-penilaian-kinerja" ? "" : "collapsed"); ?>" data-bs-target="#kinerja-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-check"></i><span>Laporan Kinerja</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="kinerja-nav" class="nav-content collapse <?php echo e($page =="laporan-penilaian-kinerja-divisi" || $page=="laporan-penilaian-kinerja" ? "show" : ""); ?>" data-bs-parent="#sidebar-nav">
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e($page =="laporan-penilaian-keahlian-divisi" || $page=="laporan-penilaian-keahlian" ? "" : "collapsed"); ?>" data-bs-target="#keahlian-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-bookmark"></i><span>Laporan Keahlian</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="keahlian-nav" class="nav-content collapse <?php echo e($page =="laporan-penilaian-keahlian-divisi" || $page=="laporan-penilaian-keahlian" ? "show" : ""); ?>" data-bs-parent="#sidebar-nav">
          <li>
