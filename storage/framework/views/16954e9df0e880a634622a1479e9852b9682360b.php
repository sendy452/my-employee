        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="<?php echo e(url('penilaian-keahlian')); ?>">
                <?php echo csrf_field(); ?>
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    <tbody>               
                    <form method="post" action="<?php echo e(route('add.penilaian.keahlian')); ?>">
                    <?php echo csrf_field(); ?>
                      ...
                      <tr>   
                        ...
                        <td><?php $__currentLoopData = $totalkeahlianakhir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($tk->total != 0 ? $tk->total : "0"); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>%</td>
                        <td>Sangat Baik</td>
                        <td>76 - 100%</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td colspan="2"><input type="text" name="id_form" value="FPKH/<?php echo e($bulan); ?>/<?php echo e($bio->id_karyawan); ?>" hidden>FPKH/<?php echo e($bulan); ?>/<?php echo e($bio->id_karyawan); ?></td>
                        <td colspan="1"><input type="text" name="bulan" value="<?php echo e(date('F-Y',strtotime($bulan))); ?>" hidden><?php echo e(date('F-Y',strtotime($bulan))); ?></td>
                      ...
                      <?php $no = 0;?>
                      <?php $total_bobot = 0;?>
                      <?php $__currentLoopData = $keahlian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          <td colspan="5"><input type="text" class="form-control" name="id_divisi" value="<?php echo e($data->id_divisi); ?>" hidden><input value="<?php echo e($data->id_keahlian); ?>" name="id_keahlian[<?php echo e($no+1); ?>]" hidden><?php echo e($data->keahlian); ?></td>
                          <td colspan="2"><input onblur="findTotal()" type="number" class="bobot" value="<?php echo e($data->bobot); ?>" hidden/><?php echo e($data->bobot); ?>%</td>
                          <td><input onblur="findTotal()" type="number" min="0" max="100" name="nilai[<?php echo e($no+1); ?>]" class="nilai" required/><br></td>
                          <td><input onblur="findTotal()" type="number" step="0.01" name="bobot_nilai[<?php echo e($no+1); ?>]" id="bobot_nilai<?php echo e($i); ?>" value="0"/></td>
                      </tr>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Apk\laragon\www\my-employee\resources\views/penilaian-keahlian.blade.php ENDPATH**/ ?>