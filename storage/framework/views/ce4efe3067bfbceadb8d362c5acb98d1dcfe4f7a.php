                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="post" action="<?php echo e(route('profile.change')); ?>">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nik" type="number" class="form-control" value="<?php echo e($data->nik); ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nip" type="text" class="form-control" value="<?php echo e($data->nip); ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nohp" type="number" class="form-control" value="<?php echo e($data->nohp); ?>" required>
                      </div>
                    </div>
